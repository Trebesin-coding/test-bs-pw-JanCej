...
- pomocí knihovny Beautiful soup projde následující [stránku]([url](https://souhrada.github.io/bsoup-exam/))
...
- se připojí následující [stránku]([url](https://souhrada.github.io/playwright-exam/))
